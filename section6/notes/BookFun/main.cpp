...
int main() {
    ...
    //Challenge: refactor printBookDetails to be part of the class
...
// void printBookDetails(const Book& book) {
//     cout << book.getTitle() << " by " << book.getAuthor() << " has " <<
//         book.getNumPages() << " pages and its genre is " << book.getGenre() << endl;
// }